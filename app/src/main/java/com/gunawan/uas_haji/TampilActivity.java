...
public class TampilActivity extends AppCompatActivity {
    ...
    private void showEmployee(){
        ...
        ListAdapter adapter = new SimpleAdapter(
                ...
                new String[]{Konfigurasi.TAG_NAMA, Konfigurasi.TAG_NOHP, Konfigurasi.TAG_ALAMAT, Konfigurasi.TAG_JENISKELAMIN},
                new int[]{R.id.nama, R.id.nohp, R.id.alamat, R.id.jenis_kelamin});
